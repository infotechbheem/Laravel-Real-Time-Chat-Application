            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!--[if BLOCK]><![endif]--><?php if($message['sender'] != auth()->user()->name): ?>
                    <div class="clearfix w-50">
                        <div class="bg-gray-300 mx-4 my-2 p-2 rounded-lg  max-w-[60%]">
                ...
                <?php else: ?>
                    <div class="clearfix">
                        <div class="text-end w-50 float-right">
                            <p class="bg-green-300 mx-4 my-2 p-2 rounded-lg  max-w-[60%]">
                                <?php echo e($message['message']); ?> <b>: You</b>
                            </p>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\ChatApplication\laravel-reverb-chat-app\resources\views/livewire/chat-component.blade.php ENDPATH**/ ?>